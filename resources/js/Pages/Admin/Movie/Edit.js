...
export default function Create({auth, movie}) {
    const { data, setData,  processing, errors } = useForm({
        //... artinya mengambil semua dari movie
        ...movie
    });
    ...
    const submit = (e) => {
        ...
        //agar thumbnail tidak duplikat (karena thumbnail disimpan ke storage) maka harus dibuat kondisi berikut
    ...
    return (
        <Authenticated auth={auth}>
            ...
            <form className="" onSubmit={submit}>
                ...
                />
                <Label forInput="thumbnail" value="Thumbmail" className="mt-4"/>
